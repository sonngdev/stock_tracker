...
SECRET_KEY = "django-insecure-9#limzi25hrbr+1v1w6hya4j6(^_73f-r1dbhy@snv=*abctsq"
...
# This production code might break development mode, so we check whether we're in Development
if not is_dev_env:
